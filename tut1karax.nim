      ...
      tdiv(class="row"):        
        ...
        tdiv(class="nine columns",id="content"):          
          ...
          p():            
            ...
            text t "means "            
            text t "\""            
            text t "enforce compile time evaluation and put it into a data section"            
            text t "\""            
            text t ":"          
          text t "\x0A            "          
          pre(class="listing"):            
          ...
          p():            
            ...
            tt(class="docutils literal"):              
              span(class="pre"):                
                text t "question"            
            text t " "            
            text t "and returns true if they answered "            
            text t "\""            
            text t "yes"            
            text t "\""            
            text t " "            
          ...
          p():            
            ...
            text t "\""            
            text t "does not imply a subtype relationship between it and its base type"            
            text t "\""            
            text t ". You must "            
            strong():              
              text t "explicitly"            
